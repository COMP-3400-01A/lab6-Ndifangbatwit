...
all: parta_main test_parta_init test_parta_run_proc test_parta_fcfs test_parta_rr_next test_parta_rr

parta_main: parta_main.c parta.c
	$(CC) $(CFLAGS) -o parta_main parta_main.c parta.c
...
.PHONY: clean
clean:
	rm -rf parta_main test_parta_init test_parta_run_proc test_parta_fcfs test_parta_rr_next test_parta_rr
